#!/usr/bin/env python
# -*- coding: utf-8 -*-
# cookietemple documentation build configuration file, created by sphinx-quickstart on Fri Jun  9 13:47:02 2017.
...
# If extensions (or modules to document with autodoc) are in another directory, add these directories to sys.path here. If the directory is
# relative to the documentation root, use os.path.abspath to make it absolute, like shown here.
