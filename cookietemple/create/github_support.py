...
def prompt_github_repo(dot_cookietemple: Optional[dict]) -> Tuple[bool, bool, bool, str]:
    ...
    console.print('[bold blue]Automatically creating a Github repository with cookietemple is strongly recommended. Otherwise you will not be able to use all of '
          'cookietemple\'s features!\n')
