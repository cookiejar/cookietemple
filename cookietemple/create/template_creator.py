...
class TemplateCreator:
    ...
    def create_template_without_subdomain(self, domain_path: str) -> None:
        ...
        if occupied:
            ...
            if cookietemple_questionary('confirm', 'Do you really want to continue?', default_value='Yes'):
    ...
    def prompt_general_template_configuration(self):
        ...
        self.creator_ctx.project_name = cookietemple_questionary('text', 'Project name', default_value='Exploding Springfield')
        ...
        while self.readthedocs_slug_already_exists(self.creator_ctx.project_name):
            ...
            if cookietemple_questionary('confirm', 'Do you want to choose another name for your project?\n'
                                                   'Otherwise you will not be able to host your docs at readthedocs.io!', default_value='Yes'):
                self.creator_ctx.project_name = cookietemple_questionary('text', 'Project name', default_value='Exploding Springfield')
        ...
        self.creator_ctx.project_short_description = cookietemple_questionary('text', 'Short description of your project',
                                                                              default_value=f'{self.creator_ctx.project_name}. A cookietemple based .')
        poss_vers = cookietemple_questionary('text', 'Initial version of your project', default_value='0.1.0')
